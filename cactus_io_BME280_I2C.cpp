...
float BME280_I2C::getAltitude(float currentSeaLevelPressureInPa)
{
    ...
    float altitude = 44330.0 * (1.0 - pow(pressurePa / currentSeaLevelPressureInPa, 0.1902949571836346));
    return altitude;
}
